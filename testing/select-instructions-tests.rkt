...
(define expect_prog_1 '(program () ((block ()(label start) (movq (int 42) (reg rax)) (jmp conclusion)))))
...
(define expect_prog_2 '(program (x y z) ((block () (label start) (movq (int 42) (reg rax)) (jmp conclusion)))))
